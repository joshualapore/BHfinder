  ...
  if (isset($_POST['changestatus'])){
     ...
     //Validating our $rentalspaceavail
        if (empty($_POST["space"])) {
            ...
            $rentalspaceavail = test_input($_POST["space"]);
            ...
            if($count == 0){
                              ...
                              $rentalspace = mysqli_real_escape_string($conn, $_POST['space']);
                            

                              mysqli_query($conn, "UPDATE rentalaccount set rentalspaceavail ='$rentalspace' where id=".$idspace);
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <div class="login-box">
           ...
           <h3 class="text-info ">Change Number of Space Available</h3>
           <br/>
                ...
                <form class="text-monospace" method="post" action="">
                                          ...
                                          <input  class="form-control" type="text" name="space" placeholder="change number of space Available" >
