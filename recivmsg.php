...
<head>
  ...
  <title>ClientAccount | BHfinder</title>
       ...
       <?php echo $dashboard; ?>
        ...
        <?php echo $client; ?>
         ...
         <?php echo $admin; ?>
          ...
          <li class="active">
            <a href="recivmsg.php"><i class="fa fa-envelope-o" style="color: #8bd8bd"></i> <span>Message</span>
...
<!-- Content Wrapper. Contains page content -->
   <div class="jumbotron" style="background: #212b34;">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="container-fluid">
              <table id="example1" class="table-striped" >


                <thead style="width:100%">
                <tr>
                  <th class="" style="width: 30%;">Sender</th>
          ...
          $query = mysqli_query($conn, "SELECT  * FROM usermsg WHERE receiverusername ='$user_' ORDER BY msgdate DESC");
          $num_rows=mysqli_num_rows($query);
          echo"Message count: ".$num_rows;
            ...
            ?>
                ...
                <tr style="line-height: 45px" >
                    <td class="" style="padding-left: 5px;">
                      ...
                      <?php 
                    if ($row['readmsg'] == '') {
                      echo "<i class='fa fa-envelope text-success'> </i> ";      
                      echo "<span class='text-success' style='font-weight: bold'>";             
                    echo $row['senderusername'];
                    echo "</span>";

                  }else if  ($row['readmsg'] == 'yes'){
                   

                     echo "<i class='fa fa-envelope-open text-success'> </i> ";      
                      echo "<span class='text-success' style='font-weight: normal'>";             
                    echo $row['senderusername'];
                    echo "</span>";
                  }
                 ...
                 <?php 
                  ...
                  ?>
                    ...
                    <td>
                      ...
                      <!--
                            <a  style="width: 60px"  class="btn btn-info " name="sendr" href="viewmsg.php?view=<?php //echo $row['id'];?>" >
                           View</a>
                      -->
                      <button style="" class="btn btn-info" type='submit' name="openmsg" id="openmsg">View</button>
                

                        <button style="width: 40px" type='submit' name='delete_button' class="btn btn-danger " id='delete_button' onclick='confirmation();return false;'><i class="fa fa-trash"></i></button>
    ...
    <!-- /.content -->
                          ...
                          $id=$_POST['id'];
                          mysqli_query($conn, "DELETE FROM usermsg WHERE id=".$id);
                          ...
                          //update send
                            if (isset($_POST['openmsg'])){

                          $id=$_POST['id'];
                          mysqli_query($conn, "UPDATE usermsg SET readmsg = 'yes', msgcount = 0 WHERE id=".$id);

                          $query =  $_POST['id'];  
                             echo "<script type='text/javascript'>window.top.location='viewmsg.php?view=".$query."';</script>";
...
<script type="text/javascript">
    ...
    function confirmation()
     {
            if(confirm("Are you sure you want to delete this message?")==1)
        {
