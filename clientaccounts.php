...
if ($id == 99 && $userlevel =='super' ) {
  ...
  $client = '<li class="active"><a href="clientaccounts.php"><i class="fa fa-users" style="color: #8bd8bd"></i> <span>Client Account</span></a></li>';
...
<!-- Content Wrapper. Contains page content -->
   <div class="jumbotron" style="background: #212b34;">
      ...
      color: #243665">find</span>er</span> Client  Management</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          $query = mysqli_query($conn, "SELECT  * from users WHERE userlevel LIKE 'user' order by id DESC");
                ...
                <tr >
                    ...
                    <td>
                      ...
                      <input  type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            ...
                            <a style="width: 60px"  class="btn btn-info "  href="viewaccount.php?view=<?php echo $row['id']; ?>"   >View</a>
