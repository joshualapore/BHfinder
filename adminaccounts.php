...
<!-- Content Wrapper. Contains page content -->
   <div class="jumbotron" style="background: #212b34;">
      ...
      color: #243665">find</span>er</span> Admin  Management</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          $query = mysqli_query($conn, "SELECT  * from users WHERE userlevel LIKE 'admin' order by id DESC");
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <input  type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            ...
                            <a style="width: 70px"  class="btn btn-info "  href="viewaccount.php?view=<?php echo $row['id']; ?>"   >View</a>



                        <input style="width: 70px" type='submit' name='delete_button' class="btn btn-danger" id='delete_button' value='Delete' onclick='confirmation();return false;'>
                    </form>
                  </div>
