      ...
      <!--------------------------
        ...
        -------------------------->
              ...
              <?php
                       ...
                       if (isset($_GET['send']))
                         {
                          $query = mysqli_query($conn, "select * from rentalaccount where id=".$_GET['send']);
                          $row = mysqli_fetch_assoc($query);
                               ...
                               $idrental = $_GET['send'];
                                ...
                                $idrentalhost_username = $row['host_username'];
                                $rental_vacancytype = $row['vacancytype'];
...
<div class="col-md-8">
 ...
 <form  method="post" action="" name="" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" readonly="" value="To: <?php echo $idrentalhost_username; ?>"><br>

             <input type="text" class="form-control" readonly="" value="Subject: <?php echo $rental_vacancytype; ?>"><br>
            
             
           
              <pre><textarea class="form-control"  placeholder="Write your message here.."  name="msgto"  style="resize:none;
height: 320px;
max-height: 320px;
outline: none">
</textarea></pre>
            ...
            <input class="btn btn-primary"  type="submit" value="Send" name="sendmsg" style="width: 30%">
...
$msgto = mysqli_real_escape_string($conn, $_POST['msgto']);
$time = date("Y-m-d H:i");
$idrental = $_GET['send'];
$idrentalhost_username = $row['host_username'];
$rental_vacancytype = $row['vacancytype'];
...
$sqle = "INSERT INTO usermsg (receiverusername,senderusername,typevacancy, msgto,msgdate,msgcount) 
VALUES ('$idrentalhost_username','$user__','$rental_vacancytype','$msgto','$time',1)" or die (mysqli_error());
            ...
            window.top.location='recivmsg.php';
            exit();
            </script>";
        }else{
           echo "<script type='text/javascript'>
